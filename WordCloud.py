...
stop = stopwords.words('portuguese') + punctuation + ['http://snowball.tartarus.org/algorithms/portuguese/stop.txt']
fname = 'Insira O caminho do Projeto/Analise_hoje.json'
...
with open(fname, 'r', newline='\r\n') as f:
    ...
    for line in f:
        ...
        terms_only = [term for term in preprocess(tweet['text'].lower()) if
...
for index, row in df.iterrows():
    ...
    word_string += (row['terms'] + ' ') * int(row['frec'] / 100)

#print (word_string)

wordcloud = WordCloud(font_path='C:\Twitter_mining\Aaargh.ttf',
                      stopwords=STOPWORDS,
